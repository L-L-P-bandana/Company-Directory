-- ===================================================================
--  MySQL database - geographical information system (HOSTINGER SAFE)
-- ===================================================================

-- Use existing database (no DROP/CREATE needed)
-- USE gazetteer; -- commented out since you're already in the database
...
CREATE TABLE countries (
    ...
    area_km2 DECIMAL(12,2) COMMENT 'Area in square kilometers',
...
-- ===================================================================
-- 3. COUNTRY_CURRENCIES TABLE (Many-to-many relationship)
-- ===================================================================
...
-- ===================================================================
-- 5. COUNTRY_LANGUAGES TABLE (Many-to-many relationship)
-- ===================================================================
...
CREATE TABLE weather_forecast (
    ...
    temperature DECIMAL(4,1) COMMENT 'Forecasted temperature',
    min_temperature DECIMAL(4,1) COMMENT 'Minimum temperature',
    max_temperature DECIMAL(4,1) COMMENT 'Maximum temperature',
...
-- Insert sample countries (will be populated from REST Countries API)
...
-- Procedure to get complete country information
...
-- Procedure to update weather data
...
-- View for complete country information

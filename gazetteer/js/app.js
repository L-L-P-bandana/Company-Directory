...
/* DEBUG UTILITIES (where used in troubleshooting, left here as evidence but I can remove if needed) */
const log = {
...
async function loadCurrencyDataQuietly(countryData) {
    try {
        ...
        // Set smart defaults (fallback should capture fail)
        ...
        log.success('Currency data loaded');

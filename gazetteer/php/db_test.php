<?php
// ===================================================================
// DATABASE CONNECTION TEST - Let's make sure everything works!
// ===================================================================
...
try {
    ...
    // Test 3: Test a sample query using the view
    ...
    if (count($tables) >= 10 && $currencyCount > 0 && $languageCount > 0) {
        ...
        echo "✅ Ready for data population scripts<br>";
        echo "</div>";
    } else {
    ...
    echo "• Check database credentials<br>";
    echo "• Verify database name<br>";
    echo "• Ensure database exists in Hostinger<br>";
    echo "• Check if database user has permissions<br>";
    echo "</div>";
}
